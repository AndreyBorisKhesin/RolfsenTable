...
\newcommand\pdfsize[2]{\noindent\makebox[\textwidth][c]{\begin{minipage}{#2}
\includegraphics[width=#2]{#1.pdf}\end{minipage}}}
\newcommand\pdf[1]{\pdfsize{#1}{3in}}
\newcommand\pdfc[1]{\pdfsize{#1}{\columnwidth}}
\newcommand\pdfex[2]{\noindent\begin{minipage}{\columnwidth}\pdf{#1}

\pdf{#1ex}\end{minipage}}
\newcommand\pdfmsgsize[2]{\pdf{#1msg}

\pdf{#1}}
\newcommand\pdfmsg[1]{\pdfmsgsize{#1}{3in}}
\newcommand\pdfmsgex[1]{\noindent\begin{minipage}{\columnwidth}\pdfmsg{#1}

\pdf{#1ex}\end{minipage}}

\newcommand\code[0]{\renewcommand\pdfsize[2]{\noindent
\makebox[\textwidth][c]{\begin{minipage}{##2}
\includegraphics[width=##2]{code/##1.pdf}\end{minipage}}}}
\newcommand\codefolder[1]{\renewcommand\pdfsize[2]{\noindent
\makebox[\textwidth][c]{\begin{minipage}{##2}
\includegraphics[width=##2]{#1/##1.pdf}\end{minipage}}}}
...
\csname fig##1\endcsname{Fig.~\arabic{paperfigurecounter}\noexpand\xspace}}
\renewcommand\pdf[1]{\pdfsize{##1}{5.5in}}
\renewcommand\pdfmsg[1]{\pdfmsgsize{##1}{5.5in}}
