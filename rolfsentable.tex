...
\papereq{BracketPlus}{\langle+XING\rangle
=A\langle VERT\rangle+B\langle HORIZ\rangle}{}
\papereq{BracketMinus}{\langle-XING\rangle
=A\langle HORIZ\rangle+B\langle VERT\rangle}{}
...
\papereq{TrefoilOne}{\fontsize{10.5pt}{1em}\selectfont\langle a\rangle
=A^3\langle b\rangle+3A^2B\langle c\rangle+3AB^2\langle d\rangle
+B^3\langle e\rangle}{}
...
\papereq{TrefoilTwo}{\langle a\rangle=A^3d^2+3A^2Bd+3AB^2d^2+B^3d^3}{}
...
\papereq{TrefoilJones}{J(LHT)=\text-q^{\text-4}+q^{\text-3}+q^{\text-1}}{}
