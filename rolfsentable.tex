...
\paperfig{Composite}
{\begin{center}\svgsize{composite}{0.7\columnwidth}\end{center}}
...
\vspace{-3em}
\begin{center}\scalebox{1.25}{\hspace{-0.1\columnwidth}\pdf{graph}}\end{center}
\vspace{-3em}
...
\papersec{The Result}\vspace{-0.5em}
